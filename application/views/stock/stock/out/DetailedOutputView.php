	...
	<div class="row">
		...
		<div class="card-panel col s12 m12 l10">
			<div class="col s12">
				...
				<ul class="col s12 m12 l4 right collection">
		...
		<div class="container right-align col s12 m12 l10">
			<button id="add_product_input_stock_final_btn" type="submit" class="green btn-large">Finalizar<i class="material-icons right">send</i></button>
		</div>
