	<div class="container">
		...
		<h4 align="center">Alterar Dados</h4>
			...
			<form class="col s12" action="<?= base_url("update-people/$id")?>" id="update-form" method="POST">
				<div>
				    <div style="font-style: italic;" id="mensagens"></div>
...
$('#update-form').validate({  
            ...
            messages: {  
                updatePeopleName: { required: '<p class="col s6" style="color: red;">Preencha o campo Nome<br>', minlength: '<p class="col s6" style="color: red;">No mínimo 5 letras <br>'}, 
                updatePeopleAdress: { required: '<p class="col s6" style="color: red;">Preencha o campo Endereco <br>'},
                updatePeopleNeighborhood: {required:'<p class="col s6" style="color: red;">Preencha o campo Bairro<br>'},
                updatePeopleDateBirth:  { required: '<p class="col s6" style="color: red;">Preencha a Data de Nascimento<br>',maxlength:'<p style="color: red;">Informe uma data válida<br>'}, 
                updatePeopleCep: { required: '<p class="col s6" style="color: red;">Preencha o campo CEP<br>',}, 
                updatePeopleNumber:  { required: '<p class="col s6" style="color: red;">Preencha o campo Numero <br>', digits:'<p class="col s6" style="color: red;">Apenas numeros <br>'}, 
                state: {required: '<p class="col s6" style="color: red;">Escolha um estado <br>',},
                updatePeopleCnpj: { required: '<p class="col s6" style="color: red;">Preencha o campo CNPJ <br>'}, 
                updatePeopleInsc: { required: '<p class="col s6" style="color: red;">Preencha o campo Inscrição Estadual <br>'},
                updatePeopleCpf: { required: '<p class="col s6" style="color: red;">Preencha o campo CPF<br>',}, 
                updatePeopleRg: { required: '<p class="col s6" style="color: red;">Preencha o campo RG<br>',},
                updatePeopleCitie: {required: '<p class="col s6" style="color: red;">Escolha uma cidade <br>',},
