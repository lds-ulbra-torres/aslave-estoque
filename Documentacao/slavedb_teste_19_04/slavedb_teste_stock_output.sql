...
CREATE TABLE `stock_output` (
  ...
  KEY `fk_stock_output_people1_idx` (`id_people`),
  CONSTRAINT `fk_stock_output_people1` FOREIGN KEY (`id_people`) REFERENCES `people` (`id_people`) ON DELETE NO ACTION ON UPDATE NO ACTION
